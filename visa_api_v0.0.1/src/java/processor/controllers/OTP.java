 ...
 * @author kjacone
 */
public class OTP extends MustHave {

    @Override
    public String sendData(String incoming_request) {
        JSONObject js = new JSONObject();
        try {
            js = new CommonFunctions().uploadToServer(Config.OTP, incoming_request);
    ...
    public String decodeResponseBody(String incoming_response) {
        ...
        try {
            ...
            if (rspCode.equalsIgnoreCase("00")) {
                jess1.put("f48", "OTP was sent to your mobile number");
                jess1.put("f39", "00");
                jess1.put("code", jess.getString("Otp"));
            } else {
